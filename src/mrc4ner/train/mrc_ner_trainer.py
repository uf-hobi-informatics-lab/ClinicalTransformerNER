...
from models.bert_query_ner import BertQueryNER, MegatronQueryNER
...
class BertLabeling(pl.LightningModule):
    def __init__(
        ...
        if self.args.model_type == "bert":
            ...
            raise RuntimeError(f"model type should be bert or megatron but {self.args.model_type}")
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--model_type", type=str, default="bert", help="bert or megatron")
